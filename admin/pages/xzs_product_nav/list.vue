    ...
    <view class="uni-container">
      <unicloud-db ref="udb" :collection="collectionList" field="classname,orderid,icon,state" :where="where" page-data="replace"
        ...
        <uni-table ref="table" :loading="loading" :emptyText="error.message || '没有更多数据'" border stripe type="selection" @selection-change="selectionChange">
          <uni-tr>
            <uni-th align="center" filter-type="search" @filter-change="filterChange($event, 'classname')" sortable @sort-change="sortChange($event, 'classname')">名称</uni-th>
...
<script>
  import { enumConverter, filterToWhere } from '../../js_sdk/validator/xzs_product_nav.js';
  ...
  export default {
    data() {
      return {
        collectionList: "xzs_product_nav",
        query: '',
        where: '',
        orderby: dbOrderBy,
        orderByFieldName: "",
